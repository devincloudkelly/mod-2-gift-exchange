...
Event.create(name: "Flatiron Holiday", date: "12-20-2019", location_id: Location.all.sample.id, dollar_amt_limit: 50, description: "Come enjoy food, drinks and the company of friends.")
